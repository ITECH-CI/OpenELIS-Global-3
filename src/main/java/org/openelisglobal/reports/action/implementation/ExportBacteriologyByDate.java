...
import org.openelisglobal.reports.action.implementation.reportBeans.BacteriologyColumnBuilder;
import org.openelisglobal.reports.action.implementation.reportBeans.RoutineColumnBuilder;
import org.openelisglobal.reports.form.ReportForm;
import org.openelisglobal.spring.util.SpringContext;

/**
 * Bacteriology CSV Export Report Exports bacteriology test results with patient
 * information and observation history
 */
public class ExportBacteriologyByDate extends CSVRoutineSampleExportReport
    ...
    protected String reportFileName() {
        return "ExportBacteriologyByDate";
    }
    ...
    public void setRequestParameters(ReportForm form) {
        try {
            ...
            Log.error("Error in ExportBacteriologyByDate.setRequestParameters: ", e);
        }
    }

    protected String getReportNameForParameterPage() {
        return MessageUtil.getMessage("sidenav.label.bacterio.csvexport");
    }
    ...
    private RoutineColumnBuilder getColumnBuilder() {
        return new BacteriologyColumnBuilder(dateRange);
    }
