...
public class ObservationHistoryServiceImpl extends AuditableBaseObjectServiceImpl<ObservationHistory, String>
    ...
    public enum ObservationType {
        ...
        HIV_STATUS("hivStatus"), HIV_TESTED_TYPE("hivTestedType"), VL_PREGNANCY("vlPregnancy"), VL_SUCKLE("vlSuckle"),
        TB_ORDER_REASON("TbOrderReason"), TB_DIAGNOSTIC_REASON("TbDiagnosticReason"),
        TB_FOLLOWUP_REASON("TbFollowupReason"), TB_FOLLOWUP_PERIOD_LINE1("TbFollowupReasonPeriodLine1"),
        ...
        BACTERIO_ORDER_TYPE("BacterioTypeExamens");
