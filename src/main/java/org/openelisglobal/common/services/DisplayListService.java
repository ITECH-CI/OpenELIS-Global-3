...
public class DisplayListService implements LocaleChangeListener {
    ...
    public void localeChanged(String locale) {
        ...
        typeToListMap.put(ListType.PROGRAM_CODE_LIST, createProgramCodeList());
        typeToListMap.put(ListType.CLINICAL_INFOS, createDictionaryListForCategory("clinical Informations"));
        typeToListMap.put(ListType.INVASIVE_GESTURES, createDictionaryListForCategory("Invasive Gestures"));
        typeToListMap.put(ListType.INDWELLING_DEVICES, createDictionaryListForCategory("Indwelling Devices"));
    ...
    public void refreshList(ListType listType) {
        ...
        case PROGRAM_CODE_LIST: {
            typeToListMap.put(ListType.PROGRAM_CODE_LIST, createProgramCodeList());
        }
        case CLINICAL_INFOS: {
            typeToListMap.put(ListType.CLINICAL_INFOS, createDictionaryListForCategory("clinical Informations"));
        }
        case INVASIVE_GESTURES: {
            typeToListMap.put(ListType.INVASIVE_GESTURES, createDictionaryListForCategory("Invasive Gestures"));
        }
        case INDWELLING_DEVICES: {
            typeToListMap.put(ListType.INDWELLING_DEVICES, createDictionaryListForCategory("Indwelling Devices"));
        }
        case BACTERIOLOGY_ANTIBIOTICS: {
            typeToListMap.put(ListType.BACTERIOLOGY_ANTIBIOTICS,
                    createDictionaryListForCategory("Bacteriology Antibiotics"));
        }
        case THERAPEUTIC_ANTIBIOTICS: {
            typeToListMap.put(ListType.THERAPEUTIC_ANTIBIOTICS,
                    createDictionaryListForCategory("Therapeutic Antibiotics"));
        }
        }
    }
    ...
    private List<IdValuePair> createProgramCodeList() {
        List<IdValuePair> programCodeList = new ArrayList<>();
